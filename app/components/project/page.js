...
export default function Project(){
    return(
        <main className="min-h-screen max-w-screen bg-gray-200">
          ...
          <div className="grid py-10 md:grid-cols-3 lg:grid-cols-3 md:ml-20 md:py-20 lg:py-20 lg:ml-20">
             <div className="mx-2 w-100 shadow-xl h-80 bg-white">
                <div className="w-full h-50 shadow-xl bg-blue-700">
                  ...
                  <Link href={"/#cancel"} className="ml-7 mt-7 text-blue-700">my-portfolio-tan-five-65.vercel.app</Link>
             </div>
              <div className="mx-2 mt-5 md:mt-0 lg:mt-0 w-100 shadow-xl h-80 bg-white">
              ...
              <div className="mx-2 mt-5 w-100 shadow-xl h-80 bg-white md:mt-3 lg:mt-3">
                <div className="w-full h-50 shadow-xl bg-gray-200">
                   <h1 className="text-center py-17 text-3xl">UNDER BUILDING</h1>
                </div>
                  <h1 className="font-semibold ml-7 mt-7">Personal Website</h1>
              ...
              <div className="mx-2 mt-5 w-100 shadow-xl h-80 bg-white d:mmt-3 lg:mt-3">
                <div className="w-full h-50 shadow-xl bg-gray-200">
                   <h1 className="text-center py-17 text-3xl">UNDER BUILDING</h1>
                </div>
                  <h1 className="font-semibold ml-7 mt-7">Personal Website</h1>
