       ...
       return(
        <main className="min-h-screen max-w-screen">
            <div className=" ">
              ...
              <p className="mt-3 p-5">Creative and detail-oriented Full-Stack Web Developer with experience building responsive websites and web applications using modern technologies. Proficient in both frontend (HTML, CSS, React, Next.js) and backend (Node.js, MySQL). Passionate about writing clean code, solving real-world problems, and continuously learning.</p>
              <h1 className="mt-10 ml-5 text-2xl font-bold">Technical Skills</h1>
              <p className="mt-3 p-5">Frontend: HTML5, CSS3, Next.js, React.js, Tailwind CSS, Bootstrap<br/><br/>  Backend: Node.js, MySQL, MongoDB  Tools & Firebase (Backend)<br/><br/> Other: Git & GitHub, VS Code, Postman, REST APIs, AJAX, JSON</p>
