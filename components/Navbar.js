...
export function Navbar(){
    ...
    return(
        <main className=" top-0 left-0 w-full">
            ...
            <div
            className={`fixed top-0 right-0 h-40 w-64 bg-blue-700 lg:bg-lime-300 md:bg-lime-300 lg:w-77 lg:h-115 md:h-115 xl:w-96 duration-6000 ease-in-out ${visible? "translate-x-0" : "translate-x-full"}`}>
